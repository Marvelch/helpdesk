                            ...
                            <div class="dropdown float-lg-end pe-4">
                                ...
                                <ul class="ticket__tables dropdown-menu px-2 py-3 ms-sm-n4 ms-n5"
                                    ...
                                    <li><a class="dropdown-item border-radius-md small"
                                            href="{{route('index_type_general_access')}}"><i class="fa-solid fa-book"
                                                style="margin-right: 10px;"></i>
                                            kelola Tipe Pekerjaan</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="myTable" data-order='[[ 0, "desc" ]]' data-page-length='10'
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-sm">
                                        <span class="text-xs ">{{@Str::ucfirst($item->type)}}</span>
                                    </td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{route('destroy_type',['id' => $item->id])}}"
                                                            method="post">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button type="submit"
