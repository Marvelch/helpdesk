        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('home*')) ? 'active' : '' }}" href="{{ROUTE('home')}}">
                    <div
                        ...
                        <i class="fa-solid fa-house fa-xl {{ (request()->is('home*')) ? 'active__menu' : '' }}"
                            style="color: #1b3d98; font-size: 14px;"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('users*')) ? 'active' : '' }}" href="{{ROUTE('index_users')}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-user fa-xl" style="color: #1b3d98; font-size: 14px;"></i>
                    </div>
                    <span class="nav-link-text ms-1">Users</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('bank-accounts*')) ? 'active' : '' }}" href="{{URL('/bank-accounts')}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
