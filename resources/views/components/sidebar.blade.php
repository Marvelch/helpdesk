<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if(Auth::user()->level->special_character == env('LEVEL_ADMIN') OR Auth::user()->level->special_character
            == env('LEVEL_EDITOR'))
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('users*')) ? 'active' : '' }}" href="{{ROUTE('index_users')}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-user fa-xl" style="font-size: 14px;"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../pages/virtual-reality.html">
                    ...
                    <span class="nav-link-text ms-1">Request IT</span>
                </a>
            </li>
            <!-- <li class="nav-item">
